...
> 当前生产部署（oxachain 19505）：proxy `0x8Bf8Ffee86F1D4a160f0953Eb13BEDcBF99eaF9E`，implementation `0x954940235982EE3F8D17EBF2e1E30bDdAC9c0153`，owner `0x257a0E759B4A7B97680354728cda2796eDbDBbF4`。
...
| 能力 | 函数 | 说明 |
|---|---|---|
| 充值 | `deposit()` / `depositERC20(token, amount)` | native / ERC20 入金，emit `Deposited(user, amount, token)` |
