...
> Monorepo | 12 模块 | Version `v0.3.2-20260718`
...
| v0.3.2 | 2026-07-18 | 生产 E2E 测试 + 全面修复：Web Proxy 端口/健康检查/安全头, Admin 面板 API 修复, MPC 前端验证码流程, DC/MPC/Vault 数据库建表补全, 4 个 MCP 服务环境变量和端口修复, 钱包注入浏览器测试 19/19 通过, MCP 45 tools 全部可用 |
