...
var API = "";
  ...
  var PAGE_TITLES = { noncustodial:'Non-Custodial Wallet', mpc:'MPC Wallet', waas:'WaaS · B2B Wallet Service', datacenter:'Data Center · On-Chain API', safe:'Multi-Sig Vault', aa:'AA · Session Manager', insights:'Insights · Graph & Factors', payments:'Payments · Gateway' };
...
function setupNav() {
  document.querySelectorAll('.nav-item[data-page]').forEach(function (el) {
    el.addEventListener('click', function () {
      ...
      var loaders = { noncustodial: ncDash, mpc: mpcInit, waas: waasInit, datacenter: dcInit, safe: safeInit, aa: aaInit, insights: insightsInit, payments: paymentsInit };
