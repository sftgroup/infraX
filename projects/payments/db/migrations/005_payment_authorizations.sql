-- @0xinfrax/payments — 005: period authorizations + a2a payee column
--
-- Restores the `period` capability on top of the base schema:
--   * payment_authorizations — period-scheme authorizations (permit2-style /
--     native): owner-approved funds consumed over time, one unit per period
--     boundary, charged without re-signing.
--   * payment_intents.payee — the a2a rail records the receiving wallet.
--
